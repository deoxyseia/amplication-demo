...
export class ComprobanteControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Comprobante })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: ComprobanteCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Comprobante] })
  @swagger.ApiForbiddenResponse()
  @swagger.ApiQuery({
    type: () => ComprobanteFindManyArgs,
    style: "deepObject",
    explode: true,
  })
  async findMany(
    ...
    const args = plainToClass(ComprobanteFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: ComprobanteWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
